 ...
 * @link https://github.com/foobugs/jagger
 */
class PHP53to54_Sniffs_PHP_EStrictSniff
	...
	implements PHP_CodeSniffer_Sniff
{
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		$parameters = $phpcsFile->getTokensAsString($openParenthesisPtr + 1, $closingParenthesisPtr - $openParenthesisPtr - 1);
		if (preg_match('/E_ALL\s*\|\s*E_STRICT/', $parameters)) {
			$phpcsFile->addError('E_ALL allready includes E_STRICT', $stackPtr, 'ErrorReportingAllreadyIncluded');
		}
		return true;
	}
}